import { type Configuration, ExecutionApi } from './api-client/index.js';
import type { PtyOptions, RunCommandOptions } from './types.js';
  ...
  async runCommand(
    ...
    return new Promise((resolve, reject) => {
      ...
      const timer = setTimeout(() => {
        ...
        reject(
          new Error(
            `Command timed out after ${timeout}ms. Collected output: ${output}`,
          ),
        );
      }, timeout);
